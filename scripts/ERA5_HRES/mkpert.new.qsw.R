...
strvar  <- c('qsw')     # Name of the variables for which perturbations
                                     # have to be created. 
fstrvar <- c('qsw')     # Matching name of the variable as they
...
pertdir <- c('/gpfs/scratch/bsc32/bsc32446/tmp/TMP_qsw')
