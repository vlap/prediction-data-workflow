...
strvar  <- c('t10')     # Name of the variables for which perturbations
                                     # have to be created. 
fstrvar <- c('t10')     # Matching name of the variable as they
...
pertdir <- c('/gpfs/scratch/bsc32/bsc32446/tmp/TMP_t10')
